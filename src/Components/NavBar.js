...
function NavBar() {
  ...
  const numberOfCartItems = useSelector(
    (state) => state.cartData.numberOfCartItems
  );
  ...
  return (
    ...
    >
        ...
        <Hide breakpoint="(max-width: 550px)">
          <NavLink to={'/'} className="home-page-link">
            <Image
              ...
              src={
                colorMode === 'light'
                  ? '/images/emporium-light.png'
                  : '/images/emporium-dark.png'
              }
              minWidth="160px"
              maxWidth="160px"
              marginLeft="0.75rem"
          ...
          >
            <NavLink to={'/products/1'} className="products-page-link">
              Browse
            </NavLink>
          </Text>
        </Hide>
      ...
      <SearchBar />
      <Box className="navbar-right" display="flex">
        {!isAuthenticated && !isLoading ? (
          ...
          <>
            {isLoading ? (
              ...
              <Box display="flex">
                <NavLink to={'/cart'} className="cart-page-profile-link">
                  <Flex
                    display="flex"
                    _hover={{
                      color: themeColor,
                ...
                <Menu>
                  ...
                  <MenuList>
                    ...
                    <MenuDivider />
                    <NavLink to={'/profile'} className="profile-page-link">
                      <MenuItem
                        _hover={{
                          color: themeColor,
                        }}
                    ...
                    <NavLink to={'/orders'} className="orders-page-link">
                      <MenuItem
                        _hover={{
                          color: themeColor,
                        }}
