...
import { Select, Button, Box, Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton, Input, FormControl, FormLabel, useDisclosure} from '@chakra-ui/react'
import { useAuth0 } from "@auth0/auth0-react";
import { useDispatch } from 'react-redux';
import { api } from '../../Features/routes';


function EditAddressButton(props) {
  ...
  const postcode = (document.getElementById(`form-postcode`).value  === '')?
   ...
   await dispatch(api.addresses.editAddress({
    token, 
    id: props.address.id,
    full_name: fullname,
      ...
      <ModalContent>
        ...
        <ModalBody pb={6}>
          <FormControl >
            ...
            <Select id='form-country' placeholder={props.address.country} >
          ...
          <FormControl mt={4}>  
            ...
            <Input id='form-fullname' placeholder={props.address.full_name} />
          </FormControl>
          <FormControl mt={4}>
            <FormLabel>Phone number</FormLabel>
            <Input id='form-phonenumber' placeholder={props.address.phone_number} />
          </FormControl>
          <FormControl mt={4}>
            <FormLabel>Postcode</FormLabel>
            <Input id='form-postcode' placeholder={props.address.postcode} />
          </FormControl>
          <FormControl mt={4}>
            <FormLabel>Address</FormLabel>
            <Input id='form-address' placeholder={props.address.street_address} />
          </FormControl>
          <FormControl mt={4}>
            <FormLabel>City</FormLabel>
            <Input id='form-city' placeholder={props.address.city} />
          </FormControl>
        </ModalBody>
        <ModalFooter>
